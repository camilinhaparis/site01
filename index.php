...
<div class="container px-4 py-3" id="icon-grid">
  <h2 class="pb-2 border-bottom">Profissionais em destaques</h2>
  ...
  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
    ...
    <div class="col d-flex align-items-start">
      ...
      <div>
        <h3 class="fw-bold mb-0 fs-4">Eletrecista</h3>        
      </div>
    </div>
    ...
    <div class="col d-flex align-items-start">
      <svg class="bi text-muted flex-shrink-0 me-3" width="1.75em" height="1.75em"><use xlink:href="#cpu-fill"/></svg>
      <div>
        <h3 class="fw-bold mb-0 fs-4">Manicure</h3>        
      </div>
    </div>
    ...
    <div class="col d-flex align-items-start">
      ...
      <div>
        <h3 class="fw-bold mb-0 fs-4">Encanador</h3>
    ...
    <div class="col d-flex align-items-start">
      ...
      <div>
        <h3 class="fw-bold mb-0 fs-4">Pedreiro</h3>
    ...
    <div class="col d-flex align-items-start">
      ...
      <div>
        <h3 class="fw-bold mb-0 fs-4">Jardineiro</h3>
    ...
    <div class="col d-flex align-items-start">
      ...
      <div>
        <h3 class="fw-bold mb-0 fs-4">Borracheiro</h3>
    ...
    <div class="col d-flex align-items-start">
      ...
      <div>
        <h3 class="fw-bold mb-0 fs-4">Pintor</h3>
    ...
    <div class="col d-flex align-items-start">
      ...
      <div>
        <h3 class="fw-bold mb-0 fs-4">Marceneiro</h3>        
      </div>
    </div>
  </div>
</div>
